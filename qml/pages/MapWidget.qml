...
Item {
    ...
    // 외부에서 쓰는 API
    signal clicked()
    property url iconSource: "qrc:/qml/images/icon_maps"   // 필요시 Main.qml에서 바꿔 넣어줘
    ...
    AppWidget {
        ...
        contentItem: Rectangle {
            ...
            Column {
                ...
                Image {
                    id: icon
                    source: mapWidget.iconSource
                    sourceSize.width: mapWidget.iconSize
                    sourceSize.height: mapWidget.iconSize
                    width: mapWidget.iconSize
                    height: mapWidget.iconSize
