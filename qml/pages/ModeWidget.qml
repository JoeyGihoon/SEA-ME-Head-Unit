...
Item {
    ...
    // 외부에서 쓰는 API
    signal clicked()
    property url iconSource: "qrc:/qml/images/icon_mode.qml"   // 필요시 Main.qml에서 바꿔 넣어줘
    ...
    AppWidget {
        ...
        contentItem: Rectangle {
            ...
            Column {
                ...
                Image {
                    id: icon
                    source: modeWidget.iconSource
                    sourceSize.width: modeWidget.iconSize
                    sourceSize.height: modeWidget.iconSize
