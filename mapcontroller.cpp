...
MapController::MapController(QObject *parent) : QObject(parent) {
    apiKey = "AIzaSyC-CoHnR4MKpfqVUNdTvCi4EYYQUwtt7nc";
}
...
QString MapController::getGoogleMapHtml() const {
    return R"(
            ...
            <script src="https://maps.google.com/maps/api/js?key=AIzaSyC-CoHnR4MKpfqVUNdTvCi4EYYQUwtt7nc&region=kr"></script>
            </head>
